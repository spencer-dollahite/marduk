...
enum HelpText {
    ...
    static let tips = [
        ...
        "Capital R works in Safari too: it reads the whole page with every reading motion live. Press shift command R first for Safari's Reader view and the read skips the site clutter.",
